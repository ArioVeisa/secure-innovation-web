    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="text-center mb-16">
          <p className="text-minetech-cyan font-medium mb-3 reveal">Contact Us</p>
          ...
          <div className="space-y-8 reveal">
            <div className="bg-gradient-to-b from-minetech-navy to-minetech-dark border border-minetech-cyan/10 rounded-lg p-6 md:p-8">
              ...
              <p className="text-minetech-gray mb-8">
                Fill out the form and our team will get back to you within 24 hours. We're ready to help you transform your digital presence.
              </p>
          ...
          <div className="reveal">
            <div className="bg-gradient-to-b from-minetech-navy to-minetech-dark border border-minetech-cyan/10 rounded-lg p-6 md:p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-minetech-light mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-minetech-light mb-2">
                    Your Email
                  </label>
                  <input
                    type="email"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-minetech-light mb-2">
                    Subject
                  </label>
                  <select
                    id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-minetech-light mb-2">
                    Your Message
                  </label>
                  <textarea
                    id="message"
                ...
                <div>
                  <button
                    ...
                    className={`w-full py-3 ${
                      isSubmitting ? 'bg-minetech-navy cursor-not-allowed' : 'bg-minetech-cyan hover:bg-minetech-cyan/90'
                    } text-minetech-dark font-medium rounded-md transition-colors flex items-center justify-center gap-2`}
                  >
                    {isSubmitting ? (
                      <>
                        <svg className="animate-spin -ml-1 mr-2 h-5 w-5 text-minetech-dark" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
