...
const HeroSection = () => {
  ...
  for (let i = 0; i < 30; i++) {
    ...
    particles.push(<div key={i} className="absolute w-1 h-1 rounded-full bg-minetech-cyan/30" style={{
      width: `${size}px`,
      height: `${size}px`,
      top: `${Math.random() * 100}%`,
  ...
  return <section ref={heroRef} id="home" className="relative pt-28 lg:pt-32 min-h-screen flex items-center overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-7/12 lg:pr-12 space-y-8 reveal-stagger">
            ...
            transitionDelay: "0.8s"
              ...
              <a href="#services" className="btn-outline-cyan px-8 py-3 rounded-md text-center flex items-center justify-center gap-2 group relative">
              ...
              <a href="#about" className="px-8 py-3 rounded-md bg-minetech-navy/80 text-white hover:bg-minetech-navy transition-all duration-300 text-center relative overflow-hidden group">
          ...
          <div className={`lg:w-5/12 mt-12 lg:mt-0 relative transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{
          transitionDelay: "1s"
        }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-2 -right-2 sm:bottom-0 sm:-right-8 w-20 h-20 border border-minetech-cyan/30 rounded-lg animate-float" style={{
              animationDelay: '1s'
            }}></div>
              <div className="absolute -top-4 -left-4 sm:-top-8 sm:-left-8 w-16 h-16 border border-minetech-cyan/20 rounded-full animate-float" style={{
              animationDelay: '1.5s'
            }}></div>
