...
const HeroSection = () => {
  ...
  return (
    <section
      ref={heroRef}
      id="home"
      className="relative pt-28 lg:pt-32 min-h-screen flex items-center overflow-hidden"
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-7/12 lg:pr-12 space-y-8 reveal-stagger">
            ...
            >
              <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold mb-12 text-white">
          ...
          <div
            className={`lg:w-5/12 mt-12 lg:mt-0 relative transition-all duration-1000 ${
          ...
          >
            <div className="relative">
                  ...
                  <div className="w-48 h-48 md:w-64 md:h-64 bg-minetech-dark/80 border border-minetech-cyan/40 rounded-full flex items-center justify-center animate-glow relative overflow-hidden group">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="text-center mt-4 space-y-1">
                        <h3 className="text-minetech-cyan font-medium text-lg">
                          Future of Tech
                        </h3>
                        <p className="text-minetech-light text-sm">
              ...
              <div
                className="absolute -bottom-2 -right-2 sm:bottom-0 sm:-right-8 w-20 h-20 border border-minetech-cyan/30 rounded-lg animate-float"
                style={{
                  animationDelay: "1s",
                }}
              ></div>
              <div
                className="absolute -top-4 -left-4 sm:-top-8 sm:-left-8 w-16 h-16 border border-minetech-cyan/20 rounded-full animate-float"
                style={{
                  animationDelay: "1.5s",
                }}
              ></div>
